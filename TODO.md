...
5. Add encoder-side `PADDING` metadata block support (RFC 9639 Section 8.3).
6. Add `PICTURE` metadata block support (RFC 9639 Section 8.8).
7. Add `APPLICATION` metadata block support (RFC 9639 Section 8.4).
